...
export default function TopNavigator() {
  ...
  return (
    <nav className="fixed left-0 top-0 z-10 w-full flex-col items-center bg-opacity-60 font-ChungbukJikji text-slate-500 backdrop-blur-sm dark:bg-opacity-60 dark:text-white">
      {visible ? (
