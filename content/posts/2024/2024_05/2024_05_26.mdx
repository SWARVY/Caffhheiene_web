---
title: Next, MSW 그리고 ESlint
description: 사이드 프로젝트 개발중 학습한 내용
date: 2024-05-26
thumbnail: /images/2024/2024_05/2024_05_26/2024_05_26_(1).webp
category:
  - Next.js
series: 사이드 프로젝트
---
...
> `24. 11. 18. (목) 업데이트
> 위의 내용에 **틀린 부분**이 있어, 해결 방법이 궁금하시다면 하단 링크의 포스트를 참조해주세요
> [Next App router에서 MSW 설정하기](https://caffhheiene.vercel.app/posts/detail/51)
...
![next lint](</images/2024/2024_05/2024_05_26/2024_05_26_(2).webp>)
