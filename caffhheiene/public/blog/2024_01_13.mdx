...
- [자바스크립트의 특징](#자바스크립트의-특징)
  - [싱글 스레드](#싱글-스레드)
  - [논 블로킹](#논-블로킹)
- [자바스크립트 런타임이란](#자바스크립트-런타임이란)
  - [런타임과 런타임환경](#런타임과-런타임-환경)
- [자바스크립트 런타임의 구성](#자바스크립트-런타임의-구성)
  - [Web API](#web-api)
...
![JavascriptRuntime](</blogImages/2024_01_13/2024_01_13_(1).png>)
...
![Task Queue](</blogImages/2024_01_13/2024_01_13_(2).png>)
...
![JavaScript Event Loop](</blogImages/2024_01_13/2024_01_13_(3).gif>)
