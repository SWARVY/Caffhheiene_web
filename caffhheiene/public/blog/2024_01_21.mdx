...
- [서론](#서론)
- [변경점](#변경점)
  - [Next 14버전으로의 업데이트](#next-14버전으로의-업데이트)
  - [코드 하이라이터 변경](#코드-하이라이터-변경)
  - [eslint 스타일링 변경](#eslint-스타일링-변경)
  - [모바일 뷰 수정](#모바일-뷰-수정)
- [아직 못다한 작업](#아직-못다한-작업)
  - [yarn-berry 마이그레이션 작업](#yarn-berry-마이그레이션-작업)
  - [포스트 TOC 변경](#포스트-toc-변경)
- [끝으로](#끝으로)
...
이중에서 airbnb 관련 설정을 해주기 위해서는 **@typescript-eslint/eslint-plugin** , 그리고 **@typescript-eslint/parser** 를 설치해주셔야합니다.
