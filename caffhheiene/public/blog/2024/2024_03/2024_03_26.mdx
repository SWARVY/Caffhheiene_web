...
떄때로 전달되는 props들은 반복적입니다. 이럴때는 **spread 구문**을 통해 간결하게 나타낼 수 있습니다.
...
![react key error](</blogImages/2024/2024_03/2024_03_26/2024_03_26_(2).webp>)
...
> 이때문에 가상 DOM트리와 비교하며 DOM트리릉 업데이트하는 과정이 정상적으로 작동하지 않을 수 있습니다.
...
- 외부에서 선언된 **guest** 변수 때문에 **호출할 떄마다 다른 JSX가 생성됩니다.**
...
이벤트 핸들러가 컴퓨넌트 내부에 정의되어 있긴 하지만 렌더링중에는 실행되지 않습니다. 따라서 **이벤트 핸들러는 순수할 필요가 없습니다**
...
![browser render tree](</blogImages/2024/2024_03/2024_03_26/2024_03_26_(4).webp>)
...
![react render tree](</blogImages/2024/2024_03/2024_03_26/2024_03_26_(3).webp>)
...
![react module dependency tree](</blogImages/2024/2024_03/2024_03_26/2024_03_26_(5).webp>)
