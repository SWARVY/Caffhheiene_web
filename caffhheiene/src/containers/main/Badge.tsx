...
export default function Badge({ svgImage, name, color }: BadgeProps) {
  return (
    <div
      className="flex items-center rounded-lg pb-2 pl-1 pr-1 pt-2 font-BlogContent font-bold shadow-lg transition duration-150 ease-in hover:brightness-90 md:p-2"
