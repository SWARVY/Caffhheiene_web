---
title: Next.js와 블로그를 (2)
description: Next.js 블로그 제작
date: 2023-10-09
thumbnail: /blogImages/image_10_08_(2).png
category:
  - TypeScript
  - Next.js
---
...
[1. 블로그의 핵심 기능](#블로그의-핵심-기능)
[2. Markdown을 파싱해보자](#markdown을-파싱해보자)
...
해당 라이브러리를 설치한 후 `tailwind.config.js` or `tailwind.config.ts`의 plugin 속성에 해당 라이브러리를 추가해주시면
className에 prose 하나만 넣어줘도 멀쩡해보이는 마크다운 렌더러가 완성됩니다.
